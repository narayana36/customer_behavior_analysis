...
round(100*sum(case when discount_applied = 'Yes' then 1 else 0 end)/count(*), 2) as percentage_rate
from customer
group by item_purchased
order by percentage_rate desc limit 5;

# Q7. segment customers into New, Returing, and Loyal based on their total number of 
-- previous puchases, and show the count of each segment.
...
# Q9. Are cutsomers who are repeat buyers (more than 5 previous purchases) also likely to subscribe?
select subscription_status,
